/****************************************************************************
** Meta object code from reading C++ file 'XButton.h'
**
...
#error "The header file 'XButton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 12), // "LiftButtonUp"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "QMouseEvent*"
QT_MOC_LITERAL(4, 35, 5) // "event"

    },
    "XButton\0LiftButtonUp\0\0QMouseEvent*\0"
    "event"
};
...
void XButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        XButton *_t = static_cast<XButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->LiftButtonUp((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (XButton::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XButton::LiftButtonUp)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject XButton::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_XButton.data,
      qt_meta_data_XButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void XButton::LiftButtonUp(QMouseEvent * _t1)
{
