...
QT_MOC_LITERAL(1, 13, 8), // "released"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 12) // "OnBtnRelease"

    },
    "XLoginButton\0released\0\0OnBtnRelease"
};
...
void XLoginButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        XLoginButton *_t = static_cast<XLoginButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->released(); break;
        case 1: _t->OnBtnRelease(); break;
        default: ;
        }
        ...
        {
            typedef void (XLoginButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XLoginButton::released)) {
                *result = 0;
                return;
            }
        }
